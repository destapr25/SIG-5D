...
var style_Kolam_0 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("19produksi");
    var labelText = "";
    size = 0;
    ...
    if (value > 27.000000 && value <= 134017.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 134017.000000 && value <= 268007.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 268007.000000 && value <= 401997.000000) {
            style = [ new ol.style.Style({
